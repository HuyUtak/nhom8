...
public class addQuestionVan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_question_van);
        anhxa();
    ...
    public void addQuiz(View view){
        ...
        quizcontractDao=new quizcontractDao(addQuestionVan.this);
        ...
        QuizContract quizContract=new QuizContract(null,cauhoi,option1,option2,option3,caudung,2);
        try {
            if (quizcontractDao.insertQuiz(quizContract)>0){

                showdialog();
            }else{
                Toast.makeText(addQuestionVan.this,"Thêm Thất Bại ",Toast.LENGTH_LONG).show();
            }
        }catch (Exception e){
    ...
    public  void  showdialog(){
        ...
        btnok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(addQuestionVan.this, listTracNghiemVan.class);
                startActivity(intent);
            }
        });
    }
