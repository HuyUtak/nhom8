...
public class detailTracNghiemToan extends AppCompatActivity {
    ...
    // lưu trữ  một Name -value được truyền qua phương thức onCreate = > lấy những giá trị đã lưu
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_trac_nghiem_toan);
        ...
        anhxa();
        quizcontractDao quizcontractDao=new quizcontractDao(detailTracNghiemToan.this);
            ...
            public void onClick(View view) {
                ...
                try {
                    if (quizcontractDao.updateQuiz(quiz)>0){
                        ...
                        Toast.makeText(detailTracNghiemToan.this,"lỗi",Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){
...
//                        showdialog();
//                    }else{
//                        Toast.makeText(detailTracNghiemToan.this,"lỗi",Toast.LENGTH_SHORT);
//                    }
//                }catch (Exception e){
//                    Log.e("loi", e.toString());
//                }
...
//        });
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(detailTracNghiemToan.this, listTracNghiemToan.class);
